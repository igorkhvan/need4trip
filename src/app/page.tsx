  ...
  return (
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-6xl space-y-10 px-5 md:px-8">
        ...
        {events.length === 0 ? (
          <div className="rounded-2xl border border-[#E5E7EB] bg-[#F7F7F8] px-4 py-12 text-center text-sm text-[#6B7280]">
              ...
              >
                <CardContent className="flex h-full flex-col gap-6 p-6">
                  <div className="flex items-start justify-between gap-3">
                    <CardTitle className="text-xl font-semibold text-[#0F172A]">{event.title}</CardTitle>
                    <span className="whitespace-nowrap rounded-full bg-[#F7F9FC] px-3 py-1 text-[13px] font-medium text-[#6B7280]">
                  ...
                  <div className="space-y-3 text-[15px] text-[#6B7280]">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>{event.description ? event.description.slice(0, 60) : "Детали маршрута и правила участия"}</span>
                    </div>
                  </div>
  ...
  return (
    <div className="space-y-0 bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#FF6F2C] to-[#ff874c] py-20 text-center text-white">
        ...
        <div className="relative mx-auto max-w-5xl space-y-6 px-5 md:px-8">
