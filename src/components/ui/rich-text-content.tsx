 ...
 *
 * Features:
 * - Sanitizes HTML via `sanitize-html` (battle-tested, pure Node.js, no DOM/jsdom)
 * - Works in any runtime: Node.js, Edge, Browser, Vercel serverless
...
export function RichTextContent({ html, className }: RichTextContentProps) {
  ...
  // Sanitize using battle-tested sanitize-html library
  const sanitized = sanitize(rawHtml, SANITIZE_OPTIONS);
