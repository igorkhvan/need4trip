...
export const AdminAuditActionCodes = {
  ...
  ADMIN_USER_STATUS_CHANGE_REJECTED: 'ADMIN_USER_STATUS_CHANGE_REJECTED',
} as const;
...
export const AdminAuditRejectionMap: Record<
  Extract<AdminAuditActionCode, 'ADMIN_GRANT_CREDIT' | 'ADMIN_EXTEND_SUBSCRIPTION' | 'ADMIN_USER_STATUS_CHANGED'>,
  Extract<AdminAuditActionCode, 'ADMIN_GRANT_CREDIT_REJECTED' | 'ADMIN_EXTEND_SUBSCRIPTION_REJECTED' | 'ADMIN_USER_STATUS_CHANGE_REJECTED'>
> = {
  ADMIN_GRANT_CREDIT: 'ADMIN_GRANT_CREDIT_REJECTED',
  ADMIN_EXTEND_SUBSCRIPTION: 'ADMIN_EXTEND_SUBSCRIPTION_REJECTED',
  ADMIN_USER_STATUS_CHANGED: 'ADMIN_USER_STATUS_CHANGE_REJECTED',
};
