...
- **Все лимиты из БД** - включая FREE plan
- **Единая точка проверки**: `enforceClubAction()`
- **Кэширование** - 5 минут для планов, 24 часа для справочников
- **Audit пройден** - см. [Billing Audit Report](../../BILLING_AUDIT_REPORT.md)

### Database-Driven Architecture
- FREE plan хранится в `club_plans` таблице
- Динамическое вычисление требуемого плана
- Ручной сброс кэша: `POST /api/admin/cache/clear`
